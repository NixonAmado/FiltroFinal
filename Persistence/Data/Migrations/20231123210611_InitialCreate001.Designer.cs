...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20231123210611_InitialCreate001")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Refreshtoken", b =>
                {
                    ...
                    b.Property<int?>("IdUserFkNavigationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdUserFkNavigationId");
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.Property<int>("IdRolFksId")
                        .HasColumnType("int");

                    b.Property<int>("IdUserFksId")
                        .HasColumnType("int");

                    b.HasKey("IdRolFksId", "IdUserFksId");

                    b.HasIndex("IdUserFksId");
            ...
            modelBuilder.Entity("Domain.Entities.Refreshtoken", b =>
                {
                    b.HasOne("Domain.Entities.User", "IdUserFkNavigation")
                        ...
                        .HasForeignKey("IdUserFkNavigationId");
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("Domain.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("IdRolFksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("IdUserFksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
